...
const dailyData = [
  { date: "Feb 23", glucLow: 2.7, glucHigh: 10.1, glucAvg: 5.4, readiness: 83, hrvBal: null, period: "home" },
  { date: "Feb 24", glucLow: 2.7, glucHigh: 9.3, glucAvg: 5.9, readiness: 83, hrvBal: null, period: "home" },
  { date: "Feb 25", glucLow: 2.2, glucHigh: 8.0, glucAvg: 5.4, readiness: 78, hrvBal: null, period: "home" },
  { date: "Feb 26", glucLow: 2.2, glucHigh: 8.3, glucAvg: 5.2, readiness: 80, hrvBal: null, period: "home" },
  { date: "Feb 27", glucLow: 3.3, glucHigh: 8.3, glucAvg: 5.5, readiness: 86, hrvBal: 87, period: "home" },
  { date: "Feb 28", glucLow: 2.8, glucHigh: 8.1, glucAvg: 5.3, readiness: 90, hrvBal: 87, period: "home" },
  { date: "Mar 1", glucLow: 3.9, glucHigh: 8.6, glucAvg: 5.6, readiness: 89, hrvBal: 89, period: "home" },
  { date: "Mar 2", glucLow: 4.2, glucHigh: 10.1, glucAvg: 5.8, readiness: 87, hrvBal: 88, period: "home" },
  { date: "Mar 3", glucLow: 3.7, glucHigh: 8.4, glucAvg: 5.3, readiness: 87, hrvBal: 89, period: "home" },
  { date: "Mar 4", glucLow: 3.4, glucHigh: 8.6, glucAvg: 4.9, readiness: 72, hrvBal: 86, period: "home" },
  { date: "Mar 5", glucLow: 3.5, glucHigh: 8.2, glucAvg: 5.2, readiness: 90, hrvBal: 89, period: "home" },
  { date: "Mar 6", glucLow: 2.2, glucHigh: 8.9, glucAvg: 6.6, readiness: 95, hrvBal: 88, period: "ski" },
  { date: "Mar 7", glucLow: 3.6, glucHigh: 9.7, glucAvg: 6.3, readiness: 71, hrvBal: 85, period: "ski" },
  { date: "Mar 8", glucLow: 4.4, glucHigh: 8.9, glucAvg: 5.9, readiness: 85, hrvBal: 88, period: "ski" },
  { date: "Mar 9", glucLow: 3.8, glucHigh: 9.3, glucAvg: 5.5, readiness: 84, hrvBal: 86, period: "ski" },
  { date: "Mar 10", glucLow: 3.3, glucHigh: 11.6, glucAvg: 5.5, readiness: 84, hrvBal: 87, period: "ski" },
  { date: "Mar 11", glucLow: 3.8, glucHigh: 8.3, glucAvg: 5.6, readiness: 87, hrvBal: 86, period: "ski" },
  { date: "Mar 12", glucLow: 3.2, glucHigh: 11.3, glucAvg: 5.9, readiness: 68, hrvBal: 85, period: "ski" },
  { date: "Mar 13", glucLow: 2.8, glucHigh: 9.7, glucAvg: 5.2, readiness: 80, hrvBal: 86, period: "ski" },
  { date: "Mar 14", glucLow: 2.5, glucHigh: 9.4, glucAvg: 4.6, readiness: 77, hrvBal: 79, period: "ski" },
  { date: "Mar 15", glucLow: null, glucHigh: null, glucAvg: null, readiness: 91, hrvBal: 87, period: "illness" },
  { date: "Mar 16", glucLow: null, glucHigh: null, glucAvg: null, readiness: 79, hrvBal: 78, period: "illness" },
  { date: "Mar 17", glucLow: null, glucHigh: null, glucAvg: null, readiness: 31, hrvBal: 66, period: "illness" },
  { date: "Mar 18", glucLow: 3.8, glucHigh: 7.0, glucAvg: 5.8, readiness: 70, hrvBal: 82, period: "illness" },
  { date: "Mar 19", glucLow: 4.2, glucHigh: 6.6, glucAvg: 5.3, readiness: 75, hrvBal: 72, period: "recovery" },
];
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <form
        ...
        className="w-full max-w-[320px] mx-md opacity-0 animate-fade-in"
      >
    ...
    <div className="space-y-md">
      ...
      <div className="border border-border rounded-lg p-sm sm:p-md">
        ...
        <div className="h-[360px] sm:h-[440px]">
          {isClient ? (
            <Suspense fallback={<div className="flex h-full items-center justify-center text-sm text-faint">Loading chart...</div>}>
              <HealthChart data={dailyData} />
            </Suspense>
          ) : (
            <div className="flex h-full items-center justify-center text-sm text-faint">Loading chart...</div>
          )}
        </div>
      </div>
      ...
      <div className="space-y-md text-sm text-muted leading-relaxed">
        <section>
          ...
          <p>
            25 days of monitoring (Feb 23 – Mar 19), with a 3-day gap (Mar 15–17) when the sensor was
            removed during food poisoning. Overall average glucose <strong className="text-copy">5.5 mmol/L</strong>,
            equivalent to an HbA1c of ~5.0% — excellent metabolic health.
          </p>
          <p className="mt-xs">
            Home-cooked meals consistently keep glucose under 8.0 mmol/L. The biggest spikes came from
            carb-heavy restaurant food combined with alcohol during the ski trip:
            <strong className="text-copy"> 11.6 mmol/L</strong> (Kaiserspätzle + Weissbier, Mar 10) and
            <strong className="text-copy"> 11.3 mmol/L</strong> (Tiroler Gröstl, Mar 12).
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Baseline readiness at home averaged <strong className="text-copy">83.4</strong> with
            HRV balance 86–89 — consistent with Sam&apos;s long-term average nightly HRV of 112ms
            (top 1–2% for any age group). The ski trip showed gradual readiness erosion from
            insufficient recovery between active days plus daily alcohol. Food poisoning crashed
            readiness to <strong className="text-copy">31</strong> on Mar 17, with temperature
            deviation spiking +1.29°C above baseline. Recovery is underway but not complete —
            HRV balance at 72 as of Mar 19 (vs baseline 87–89).
          </p>
        </section>
  ...
  return (
    <div className="space-y-md">
      <p className="text-sm text-muted leading-relaxed">
        Blood tests taken Feb 25, 2026 at E. Gulbja Laboratorija, Riga.
        Full panel including metabolic markers, lipids, vitamins, and thyroid.
      </p>
...
function NutritionTab() {
  return (
    <div className="space-y-md">
      <p className="text-sm text-muted leading-relaxed">
        Complete food diary covering Feb 23 – Mar 19, 2026. Includes all meals, estimated macros
        per portion, and glucose notes where CGM data was available.
      </p>
...
function RecipeCard({ name, cuisine, protein, time, note }: {
  name: string; cuisine: string; protein: number; time: string; note: string;
}) {
  return (
    <div className="border border-border rounded-lg p-sm">
      <p className="text-[0.9375rem] text-copy font-normal">{name}</p>
      <p className="text-xs text-faint mt-0.5">{cuisine} · {protein}g protein · {time}</p>
    ...
    <div className="max-w-content mx-auto px-md pb-xl">
      ...
      <div className="mt-md mb-md">
        ...
        <p className="mt-xs text-sm text-muted">
          Prepared for Dr Lelde Klemente · Feb 23 – Mar 19, 2026
        </p>
      </div>
